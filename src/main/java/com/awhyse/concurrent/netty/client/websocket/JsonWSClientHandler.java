 ...
 */
public class JsonWSClientHandler extends ChannelInboundHandlerAdapter {
    ChannelHandlerContext ctx;
            String RegisterId;
    private static String webSocketURL = "ws://localhost:"+NettyWSServer.port+"/";
    static Logger log = LoggerFactory.getLogger(JsonWSClientHandler.class);

    public JsonWSClientHandler(){
