/**
 * @Title Page.java。
 * @Package com.hundsun.internet.iasp.service.common
 * @Description 分页模型
 * @author hanmeng
 * @date 2014年5月5日
 * @version V1.0
...
public class Page<T> {
    ...
    /**
     * @see com.hundsun.internet.iasp.service.common.Page#Page(int, int, int)
     * 每页条数使用默认值 {@link com.hundsun.internet.iasp.service.common.Constant#PER_PAGE_COUNT}
     * @param pIndex 页码
     * @param total 总条数
     * @create: 14-2-13 下午2:54 xusheng
     * @history:
