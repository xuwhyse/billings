...
public class ValueRange {
    ...
    public ValueRange() {
        try {
            ...
            InputStream is = ValueRange.class
                .getResourceAsStream("/valueRange.properties");
     ...
     * @param value 值（0,1...）
     * @return 对应值
     * @create: 2014年5月6日 下午2:26:03 linyy
     * @history:
     */
     ...
     * @param def 默认值
     * @return 对应值
     * @create: 2014年7月9日 上午9:25:11 linyy
     * @history:
     */
