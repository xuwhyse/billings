...
import com.hundsun.internet.billingsystem.common.Util;
...
import com.hundsun.internet.billingsystem.service.billingsoper.impl.SysAccountMngImpl;
...
public class AccountInterceptor implements HandlerInterceptor {
	...
	Map<String, SysAccountBean> mapAccount = SysAccountMngImpl.mapAccount;
    /**
     * 视图解析完成后.
     * @param request 请求对象
     * @param response 响应对象
