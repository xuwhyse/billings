	...
	var Slider = function(element, options) {
		...
		switch(this.orientation) {
			...
			default:
				...
				this.tooltip.addClass('bottom')[0].style.top = this.tooltip.outerHeight()  + 'px';
				this.tooltip_min.addClass('bottom')[0].style.top = this.tooltip_min.outerHeight()  + 'px';
				this.tooltip_max.addClass('bottom')[0].style.top = this.tooltip_max.outerHeight()  + 'px';
				break;
		}
