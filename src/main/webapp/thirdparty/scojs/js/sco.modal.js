	...
	$.extend(Modal.prototype, {
		show: function() {
			...
			if (!this.$modal.length) {
				this.$modal = $('<div class="modal fade modal-dialog" id="' + this.options.target.substr(1) + '"><div class="modal-content"><div class="modal-header"><a class="close" href="#" data-dismiss="modal">×</a><h3>&nbsp;</h3></div><div class="inner"/></div></div></div>').appendTo(this.options.appendTo).hide();
			}
